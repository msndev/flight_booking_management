			...
			<div class="well bs-component">
				<?php 
					if(f_logged_in()===true) {
						...
						$to = $_GET['chose_to'];
						$fro = $_GET['chose_fro'];
						$qu1 = "SELECT * FROM `flights_table` WHERE `fno`='$to'";
						$ru1 = mysql_query($qu1);
						while($ro1 = mysql_fetch_assoc($ru1)) {
							$arr1 = $ro1['arrival_time'];
						}
						$qu2 = "SELECT * FROM `flights_table` WHERE `fno`='$fro'";
						$ru2 = mysql_query($qu2);
							...
							if(isset($_GET['chose_to'])===true) {
								if(isset($_GET['chose_fro'])===true) {
									...
									$fro = $_GET['chose_fro'];
										...
										$q2 = "SELECT * FROM `flights_table` WHERE `fno`='$fro'";
										$r2 = mysql_query($q2);
		...
		<div class="col-lg-6">
			<div class="well bs-component">
				<form class="form-horizontal" action="card.php" method="GET">
					<h4>View the Adult Passenger Details</h4>
		            ...
		            <input type="hidden" name="count_a" value="<?php echo $counta; ?>"/>
              		...
              		?>
		            <center><button type="submit" id="book_f" name="book_f" style = "background-color: #b41515" class="btn btn-primary">Book Flight</button></center>
				</form>
			</div>
		</div>
