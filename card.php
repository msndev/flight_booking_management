...
<div class="row">
	...
	<div class="col-lg-4">
		<div class="well bs-component">
			...
			?>
			<legend>Add your Payment Details!</legend>
			<form class="form-horizontal" action="confirm.php" method="POST">
				...
				<div class="form-group">
					<div class="col-lg-8">
						<input type="text" required maxlength="16" class="form-control" name="cardnum" id="cardnum" placeholder="16 Digit Card Number">
					</div>
					<div class="col-lg-4">
				...
				<center>
					...
					<button type="submit" style = "background-color: #e70707; color: white;" id="book_f" name="book_f" class="btn success">Pay Now</button></center>
			</form>
		</div>
	</div>
	<div class="col-lg-4">
